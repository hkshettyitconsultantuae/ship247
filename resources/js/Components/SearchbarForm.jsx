...
import { AutoComplete, Select, Button, Form, DatePicker } from 'antd';
...
const SearchbarForm = (props) => {
    ...
    const mapCityList = (data) => {
        return data.map((loc) => {
            return { UNLocCode: loc.code, value: loc.fullname }
        });
    }
    ...
    return (
        <div className="inner-box">
            <Form name={'search-form'} autoComplete="off" form={searchForm} onFinish={handleSearchForm} className='default-form'>
                            ...
                            <div className="filter-dropdown">
                                ...
                                <div className="flex flex-col gap-y-3">
                                    <div className="form-field radio-field">
                                        <input type="radio" className='form-radio' name='pickup' />
                ...
                <div className="search-form mt-4">
                            ...
                            <div className="transportation-checkbox">
                                ...
                                <div className="option">
                                    ...
                                    <div className="content land">
                                        <span className="absolute -top-6 left-0 right-0 w-8/12 mx-auto py-1 secondary-bg text-white rounded-md">Beta</span>
                                        <i className="icon">
                                            <svg
                                                id="truck-icon"
                                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="2xl:w-3/12 w-full">
                        <Form.Item id="origin_port" name="origin_port" className="form-field"
                            ...
                            <AutoComplete
                                placeholder="From"
                                options={originList}
                                onSelect={(value, selectedOption) => setOrigin(selectedOption.UNLocCode)}
                                onSearch={(text) => {
                                    if(text.length > 1) {
                        ...
                        <div className="form-field">
                            <Form.Item id="destination_port" name="destination_port" className="form-field"
                                ...
                                <AutoComplete
                                    ...
                                    onSelect={(value, selectedOption) => setDestination(selectedOption.UNLocCode)}
                                    onSearch={(text) => {
                                        if(text.length > 1) {
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 18 18">
                            <path id="Search-icon" d="M17.822,16.78l-4.729-4.729a7.35,7.35,0,1,0-1.042,1.042l4.729,4.729a.739.739,0,0,0,1.042-1.042ZM3.192,11.556A5.874,5.874,0,1,1,7.371,13.3a5.911,5.911,0,0,1-4.178-1.745" transform="translate(0 0.001)" fill="#ffffff" />
                        </svg>
                    </Button>
